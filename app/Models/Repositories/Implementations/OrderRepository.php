...
class OrderRepository extends ListRepository implements IOrderRepository
{
    ...
    public function setCompletedStatus(string $code)
    {
        return $this->setStatus($code, Order::COMPLETED_STATUS);
    }
    ...
    public function getCookingOrdersLastMinute()
    {
        return $this->modelClass::whereDate('created_at', '>=', Carbon::now()->subMinutes(3))->get();
    }
}
